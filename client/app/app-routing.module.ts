...
const routes: Routes = [
  ...
  { path: 'people/edit/:id', canActivate: [AuthGuardService], component: EditPersonComponent },
  ...
  { path: 'institutions/edit/:id', canActivate: [AuthGuardService], component: EditInstitutionComponent },
