...
module.exports = app => {
  ...
  router.delete('/:personId/:inscriptionId', limitRate, auth.verifyAdminToken, controller.delete);
  // Delete all People In Inscriptions
  router.delete('/', controller.deleteAll);
  app.use('/api/people_in_inscriptions', limitRate, auth.verifyAdminToken, router);
};
